...
public class GestureLockView extends View {
	...
	private final int OUT_CYCLE_NORMAL = Color.rgb(108, 119, 138); // ����Բ��ɫ
	private final int OUT_CYCLE_ONTOUCH = Color.rgb(025, 066, 103); // ѡ����Բ��ɫ
	private final int INNER_CYCLE_TOUCHED = Color.rgb(002, 210, 255); // ѡ����Բ��ɫ
	private final int INNER_CYCLE_NOTOUCH = Color.rgb(100, 100, 100); // δѡ����Բ��ɫ
	private final int LINE_COLOR = Color.argb(127, 002, 210, 255); // ��������ɫ
	private final int ERROR_COLOR = Color.argb(127, 255, 000, 000); // ���Ӵ�����Ŀ��ʾ��ɫ
	private final int INNER_CYCLE_ERROR_COLOR = Color.rgb(255, 000, 000); // ���Ӵ���ʱ��Բ��ɫ
